...
shawshank = media.Movie("Shawshank Redemption",
                        ...
                        and starring Tim Robbins and Morgan Freeman. Adapted",
                        "https://upload.wikimedia.org/wikipedia/en/8/81/\
                        ShawshankRedemptionMoviePoster.jpg",
                        "https://www.youtube.com/watch?v=6hB3S9bIaco")

godather = media.Movie("The Godfather",
                       "The story spans the years from 1945 to 1955 and \
                       chronicles the fictional Italian-American Corleone crime family. When organized crime family patriarch Vito Corleone barely survives an attempt on his life, his son, Michael, steps in to take care of the would-be killers, launching a campaign of bloody revenge",
                       "https://upload.wikimedia.org/",
                       "wikipedia/en/1/1c/Godfather_ver1.jpg",
                       "https://www.youtube.com/watch?v=sY1S34973zA")
shindlerslist = media.Movie("Shindlers List",
                            "Told from the perspective of businessman Oskar \
                            Schindler who saved over a thousand Jewish lives from the Nazis while they worked as slaves in his factory. Schindler’s List is based on a true story, illustrated in black and white and controversially filmed in many original locations.",
                            "https://upload.wikimedia.org/wikipedia/en/3/38/\
