...
godather = media.Movie("The Godfather",\
    ...
    "fictional Italian-American Corleone crime family. When organized crime "\
    "family patriarch Vito Corleone barely survives an attempt on his life, his"\
...
shindlerslist = media.Movie("Shindlers List",
    ...
    " and white and controversially filmed in many original locations.",\
    "https://upload.wikimedia.org/wikipedia/en/3/38/Schindler%27s_"\
    "List_movie.jpg",\
